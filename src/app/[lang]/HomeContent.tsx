...
export default function HomeContent({ lang }: { lang: Locale }) {
  ...
  return (
    <>
      ...
      <section
        id="home"
        className="flex flex-col lg:flex-row items-center justify-center gap-8 md:gap-16 mb-6 px-2 sm:px-4"
      >
        {/* Portrait */}
          ...
          {(() => {
            ...
            return (
              <div className="mb-12 text-left">
                <p className="text-xs font-bold uppercase tracking-widest text-accent-700 mb-3">
      ...
      {/* JOURNEY — lightweight highlights */}
      <section id="journey" className="flex flex-col items-center justify-center">
        <motion.div
          variants={fadeUp}
          initial="hidden"
          animate="visible"
      ...
      {/* CONTACT */}
      <section id="contact" className="flex flex-col items-center justify-center text-center">
        <motion.div
          variants={fadeUp}
          initial="hidden"
          animate="visible"
        ...
        >
          ...
          <p className="mb-8 text-brand-800 text-base leading-relaxed">
